...
public class SimulationPlot extends PlotPanel implements IUpdateListener {
	...
	private void setPreferences() {
		_useLogT = _simulation.getAttributes().useLogTemp();
	...
	private static PlotCanvas makePlotCanvas(SimulationAttributes attributes) {
		String plotTitle = "?";
		String xLabel = "?";
		String yLabel = "?";
		plotTitle = attributes.getPlotTitle();
		xLabel = attributes.getXAxisLabel();
		yLabel = attributes.getYAxisLabel();

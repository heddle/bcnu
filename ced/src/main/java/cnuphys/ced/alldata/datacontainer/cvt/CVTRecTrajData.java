...
public class CVTRecTrajData extends ACommonTrajData {
	
	// singleton
	private static volatile CVTRecTrajData _instance;
	 ...
	 */
	public static CVTRecTrajData getInstance() {
		if (_instance == null) {
			synchronized (CVTRecTrajData.class) {
				if (_instance == null) {
					_instance = new CVTRecTrajData();
				}
			}
		}
		return _instance;
